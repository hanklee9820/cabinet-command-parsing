...
| 项目 | 发送指令 | 返回数据 |
|------|----------|-----------|
| 格式 | 01 + 05 + 02 + 05 + 0C | 每个传感器按地址顺序返回数据 |
| 示例 | 01 05 02 05 0C | 01 06 02 02 64 00 00 a7 36 |
| 说明 | - 01: 地址<br>- 05: 读数据功能码<br>- 02: 寄存器地址<br>- 05: 固定信息码<br>- 0C: 校验码 | - 01是地址 00为广播<br> - 06是功能码<br> - 02是寄存器<br> - 02是状态字节<br> - 64是分度值和负号<br> - 00 00 a7是分度数<br> - 36是效验码 |
